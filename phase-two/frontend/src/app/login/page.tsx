      ...
      <div className="relative max-w-md w-full">
        ...
        >
          <div className="space-y-2 text-center">
            ...
            <h1 className="text-3xl font-semibold text-slate-900 dark:text-slate-50">Log in</h1>
            <p className="text-sm text-slate-500 dark:text-slate-400">Sign in to manage your tasks anywhere.</p>
          </div>
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400 text-center">
            No account?{" "}
            <a className="text-[var(--accent-strong)] font-medium hover:underline" href="/signup">
              Sign up
            </a>
          </p>
        </form>
